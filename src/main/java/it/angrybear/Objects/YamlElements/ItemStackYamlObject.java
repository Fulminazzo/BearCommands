...
public class ItemStackYamlObject extends YamlObject<ItemStack> {
    ...
    @Override
    public ItemStack load(ConfigurationSection configurationSection, String path) throws Exception {
        ConfigurationSection itemSection = configurationSection.getConfigurationSection(path);
        ...
        CollectionYamlObject<ItemFlag> flagsObject = YamlObject.newObject(List.class, yamlPairs);
    ...
    public void dump(ConfigurationSection configurationSection, String path) throws Exception {
        ...
        ConfigurationSection itemSection = configurationSection.createSection(path);
